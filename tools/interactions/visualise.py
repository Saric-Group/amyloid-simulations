...
def calculate_point_rod(bead_type, rod_state):
    ...
    vals['md'] = np.array([md.bead_rod_interaction(bead_type, rod_state, r, z, psi1)
...
def calculate_rod_rod(rod1_state, rod2_state, theta = 0, phi = 0, psi2 = None):
    ...
    vals['md'] = np.array([md.rod_rod_interaction(rod1_state, rod2_state, r, z, theta, phi, psi1, psi2)
