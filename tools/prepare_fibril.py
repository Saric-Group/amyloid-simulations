...
parser.add_argument('-r', '--radius', type=float, default=1.0, help='the radius of a monomer/rod')
...
#    
# py_lmp = PyLammps()
# model = rods.Model('data/test/model.cfg')
#    
...
# py_lmp.dump("dump_cmd", "all", "custom", 100, 'data/test/test.dump', dump_elems)
