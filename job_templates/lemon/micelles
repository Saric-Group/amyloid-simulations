...
/usr/bin/time --verbose mpiexec -f $PBS_NODEFILE python "$PROJECT_HOME"/programs/micelles.py "<cfg_file>" "<run_file>" <simlen> --seed $SEED <args>

run_filename=`basename "<run_file>"`
run_filename="${run_filename%.*}"
python "$PROJECT_HOME"/tools/dump_processing.py "<cfg_file>" "<out_folder>/${run_filename}_${SEED}.dump" -c <aargs>
